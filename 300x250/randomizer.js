...
(function () {
  ...
  function run() {
    ...
    var h = chooseHeadlines(D);
    var hA = document.getElementById("headlineA");
    var hB = document.getElementById("headlineB");
    ...
    function putPerson(id, file, fb) { setPhoto(document.getElementById(id), file, foc(file), fb); }
